...
expv=0
group=0
#Loop to sum chi -square  value , the  reason  why do  calculating  only expv >=5
#is  because chi -square  test is  accuracy  when  most  groups' theoretical←↩value  more  than 5. Thus we have to  combine  some  groups
